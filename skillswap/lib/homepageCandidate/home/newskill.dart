...
class BioEdit extends StatefulWidget {
  final String bio;
  const BioEdit(this.bio,{Key? key}) : super(key: key);

  @override
  State<BioEdit> createState() => _BioEditState();
}
                  ...
                  return Column(
                    ...
                    children: [
                      CustomTextFormFieldTwo(
                          ...
                          height: height * 0.5,
                          hintText: 'Bio',
                          controller: bioController,maxLine: 10,),
                    ],
                  );
                }),
                actions: [
...
class GitEdit extends StatefulWidget {
  final String git;
  const GitEdit(this.git,{Key? key}) : super(key: key);

  @override
  State<GitEdit> createState() => _GitEditState();
}

class _GitEditState extends State<GitEdit> {
